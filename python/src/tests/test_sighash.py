...
class SigHashTest(unittest.TestCase):
    ...
    """
    SAMPLE_TX_HEX = (
        "010000000117cbf49978ccc843405f8956007563b30e61d341fb6e6d9b11775a8e38d161d"
        "2000000006b483045022100aacb290ed3aeb43fc91a179d6a3ffef4c5efcca612c901c719"
        "e198c2ee685e2702200505bd74db673c6d723a141bd8ac469327ea4bb7987110042f23f8c3"
        "d7f91e3d412103dcf21dbdbaa744333af236c3382c85d6308e6d05599df5d3cb19e0f19a205"
        "d43ffffffff02e8030000000000001976a9144d7eb7ce5ce099dd218383f3f81d3c2f1e48113"
        "f88acf0810100000000001976a914d86625de492d8bd8bbc4930f2bef4328e37f1f5388ac000"
        "00000"
    )
    SAMPLE_SCRIPT_PUBKEY = Script.parse_string(
    ...
    def test_sig_hash_chronicle_uses_otda(self):
        own_tx = Tx.parse_hexstr(self.SAMPLE_TX_HEX)
        script_pubkey = self.SAMPLE_SCRIPT_PUBKEY

        bip143_hash = sig_hash(own_tx, 0, script_pubkey, 99904, SIGHASH.ALL_FORKID)
        chronicle_hash = sig_hash(own_tx, 0, script_pubkey, 99904, SIGHASH.ALL_FORKID_CHRONICLE)
        chronicle_preimage = sig_hash_preimage(own_tx, 0, script_pubkey, 99904, SIGHASH.ALL_FORKID_CHRONICLE)
