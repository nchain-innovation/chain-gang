...
class FedTest(unittest.TestCase):
    ...
    def test_federico2(self):
        ...
        self.assertEqual(context.stack.decode_stack(), [1])
    ...
    def test_federico5(self):
        ...
        context = Context(script=script1)
        context.evaluate()
        self.assertEqual(context.stack.decode_stack(), [2])
    ...
    def test_federico8(self):
        ...
        script2 = Script.parse_string(script1.to_string())
        context2 = Context(script=script2)
        context2.evaluate()
        self.assertEqual(context2.get_stack(), test_stack)
